...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['btnreply'])) {
    ...
    // Incrementa il contatore reply_count
...
//Restituisce il nome utente associato all'ID utente da un array di risposte.
...
//Restituisce il messaggio associato all'ID del genitore da un array di risposte.
